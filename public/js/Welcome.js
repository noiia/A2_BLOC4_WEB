...
function updatePage(currentPage, totalPages, internshipsPerPage) {
    ...
    if (currentPage === 1) {
        ...
        backButton.addEventListener("click", function() { currentPage -= 1; updatePage(currentPage, totalPages, internshipsPerPage); });
    }
    ...
    if (currentPage === totalPages) {
        ...
        nextButton.addEventListener("click", function() { currentPage += 1; updatePage(currentPage, totalPages, internshipsPerPage); });
    }
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("id-button-back").addEventListener("click", function() { currentPage -= 1; updatePage(currentPage, totalPages, internshipsPerPage); });
    document.getElementById("id-button-next").addEventListener("click", function() { currentPage += 1; updatePage(currentPage, totalPages, internshipsPerPage); });
});
