...
import { parseGlob } from 'tailwindcss/src/util/parseGlob'
import { env } from 'tailwindcss/src/lib/sharedState'

/** @typedef {import('tailwindcss/types/config.d.ts').RawFile} RawFile */
/** @typedef {import('tailwindcss/types/config.d.ts').FilePath} FilePath */
